            ...
            <div class="box-body mb-1">
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <h4>Horário:</h4>
                      <input value="<?= ($infos['local_local02_horario']) ?>" type="text" name="local_local02_horario" class="form-control" placeholder="30 Dezembro 2019, 15h - 22h">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="local_local02_mapa" class="form-control" value="<?= ($infos['local_local02_mapa']) ?>" placeholder="Av. Paulista, 2000 - Bela Vista, São Paulo - SP, 01310-200">
                  </div>
                </div>

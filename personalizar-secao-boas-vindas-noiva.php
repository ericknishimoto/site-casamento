...
?>
      <form action="altera-secao-boas-vindas-noiva.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Dados da Noiva</h3>
            <!-- tools box -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <h4>Imagem:</h4>
                      <img id="imgLocal" src="upload/<?= ($infos['noiva_img']) ?>" class="thumbnail img-rounded img-md"/>
                      <input id="imgLocalInput" value="<?= ($infos['noiva_img']) ?>" type="file" name="noiva_img" class="form-control-file">
                      <input value="<?= ($infos['noiva_img']) ?>" type="hidden" name="noiva_img_anterior">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <h4>Descrição:</h4>
                      <input value="<?= ($infos['noiva_desc']) ?>" type="text" name="noiva_desc" class="form-control">
                    </div>
                </div>
